...
![Project Screenshot](https://50projects50days.com/img/projects-img/33-notes-app.png)

</div>

# Notes App

A simple app to add new notes, save the notes in browser localstorage and reterive data even after loading the page. 
